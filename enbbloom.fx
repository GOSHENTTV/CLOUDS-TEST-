...
technique11 Aaron < string UIName = "AaronX Bloom"; string RenderTarget = "RenderTargetRGBA64F"; >
{
	pass p0
	{
...
technique11 Aaron2 < string RenderTarget = "RenderTarget1024"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron4 < string RenderTarget = "RenderTarget512"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron6 < string RenderTarget = "RenderTarget256"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron8 < string RenderTarget = "RenderTarget128"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron10 < string RenderTarget = "RenderTarget64"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron12 < string RenderTarget = "RenderTarget32"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron14 < string RenderTarget = "RenderTargetRGBA32"; >
{
	pass p0
	{
...
technique11 lAaron < string UIName = "AaronX Bloom+RainLens"; string RenderTarget = "RenderTargetRGBA64F"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Pre()));
...
technique11 lAaron2 < string RenderTarget = "RenderTarget1024"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 lAaron4 < string RenderTarget = "RenderTarget512"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 lAaron6 < string RenderTarget = "RenderTarget256"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 lAaron8 < string RenderTarget = "RenderTarget128"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 lAaron10 < string RenderTarget = "RenderTarget64"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 lAaron12 < string RenderTarget = "RenderTarget32"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 lAaron14 < string RenderTarget = "RenderTargetRGBA32"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_0()));
